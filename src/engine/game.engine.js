export class GameEngine {
  ...
  async setupNewGame(playerNames) {
    ...
    const kingdomsData = [
      { name: 'RED', gloryAge1: 1, gloryAge2: 3, gloryAge3: 6 },     // Antigo GIANT (Poden)
      { name: 'BLUE', gloryAge1: 1, gloryAge2: 3, gloryAge3: 6 },    // Antigo WIZARD (Agartha)
      { name: 'ORANGE', gloryAge1: 2, gloryAge2: 4, gloryAge3: 8 },  // Antigo TROLL (Utgard)
      { name: 'GREY', gloryAge1: 2, gloryAge2: 4, gloryAge3: 8 },    // Antigo SKELETON (Koghi)
      { name: 'YELLOW', gloryAge1: 3, gloryAge2: 5, gloryAge3: 10 }, // Antigo DWARVE (Althea)
      { name: 'GREEN', gloryAge1: 3, gloryAge2: 5, gloryAge3: 10 },  // Antigo ELF (Yggdrasil)
    ];
